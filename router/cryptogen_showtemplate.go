...
const (
	cryptoShowtemplateOrderUrl       = "/exchange/cryptogen_extend"
...
func cryptoShowtemplateRouter(router *gin.Engine) {
	router.POST(cryptoShowtemplateOrderUrl, cryptoShowtemplateOrderUrlPlace)
}
...
func cryptoShowtemplateOrderUrlPlace(c *gin.Context) {
